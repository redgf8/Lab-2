...
public class Tests {
  ...
  public static void main (String args[]) {
    ...
    endTime   = System.currentTimeMillis();
    totalTime = endTime - startTime;
    cllTimes = "Time for retrieving CircularLinkedList elements: " + totalTime + " miliseconds.";
    startTime = System.currentTimeMillis();
    ...
    endTime   = System.currentTimeMillis();
    totalTime = endTime - startTime;
    cllTimes = cllTimes + "\nTime for swapping CircularLinkedList elements: " + totalTime + " miliseconds.";
    startTime = System.currentTimeMillis();
    ...
    endTime   = System.currentTimeMillis();
    totalTime = endTime - startTime;
    cllTimes = cllTimes + "\nTime for shifting CircularLinkedList elements: " + totalTime + " miliseconds.";
    startTime = System.currentTimeMillis();
    ...
    endTime   = System.currentTimeMillis();
    totalTime = endTime - startTime;
    cllTimes = cllTimes + "\nTime for adding CircularLinkedList elements: " + totalTime + " miliseconds.";
